...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/programaçao.css">
</head>
<body>
  <header>
  ...
  <div class="layout">
    <div class="sidebar">
      ...
      <a href="./programacao.php">
        <div class="sidebar-item active"><i class="fa fa-calendar"></i> Programação</div>
      </a>
      <a href="./normas.php">
    ...
    <div class="content">
      <section class="programacao">
        ...
        <p class="descricao">
          Confira abaixo a programação completa do Encontro Carioca de Alimentação Coletiva.
        </p>
        <div class="lista-programacao">
          <div class="card-programacao">
            <h2>10 de Junho</h2>
            <ul>
              <li>08:30 - Credenciamento</li>
              <li>09:30 - Abertura oficial</li>
              <li>10:00 - Palestra: Nutrição e Sustentabilidade</li>
              <li>14:00 - Mesa redonda: Alimentação Escolar</li>
            </ul>
          </div>
          <div class="card-programacao">
            <h2>11 de Junho</h2>
            <ul>
              <li>09:00 - Workshop: Planejamento de Cardápios</li>
              <li>11:00 - Apresentação de trabalhos</li>
              <li>15:00 - Palestra: Gestão de Cozinhas Institucionais</li>
            </ul>
          </div>
          <div class="card-programacao">
            <h2>12 de Junho</h2>
            <ul>
              <li>09:00 - Painel: Políticas Públicas em Nutrição</li>
              <li>11:30 - Encerramento e entrega de certificados</li>
            </ul>
          </div>
        </div>
      </section>
