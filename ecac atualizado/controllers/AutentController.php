...
class AutentController
{
    ...
    public function cadastro(): void
    {
        ...
        /* Verifica se os campos estão vazios */
        if (
            trim($dados['nome']) === '' || trim($dados['email']) === '' || trim($dados['senha_hash']) === '' ||
            trim($dados['documento']) === '' || trim($dados['data_nascimento']) === '' ||
            trim($dados['nivel_escolaridade']) === '' || trim($dados['nome_curso']) === '' ||
            trim($dados['cidade']) === '' || trim($dados['estado']) === '' || trim($dados['pais']) === ''
        ) {
