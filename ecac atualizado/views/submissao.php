      ...
      <div class="content-wrapper">
        ...
        <div class="card">
          <div class="form-group">
            ...
            <input type="text" placeholder="Ex: Análise de Dados em Ambientes Distribuídos">
          </div>
          <div class="form-group">
            <label>Autores (Separados por vírgula)</label>
            <input type="text" placeholder="Ex: João Silva, Maria Oliveira">
          </div>
          <div class="form-group">
            ...
            <div class="upload-box">
              ...
              <span class="upload-info">PDF, DOCX (Máx. 10MB)</span>
            </div>
          ...
          <button class="btn-submit">ENVIAR TRABALHO</button>
        </div>
      </div>
    </div>
  </div>
