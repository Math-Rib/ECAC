...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/palestrantes.css">
</head>
<body>
...
<div class="layout">
  <div class="sidebar">
    ...
    <a href="./eventos.php"><div class="sidebar-item"><i class="fa fa-calendar-check"></i> Evento</div></a>
    ...
    <a href="./palestrantes.php"><div class="sidebar-item active"><i class="fa fa-phone"></i> Contato</div></a>
  </div>
...
<br><br>
        ...
        <div class="contato-mapa">
          <iframe
            src="https://www.google.com/maps?q=UNISUAM%20Bonsucesso&output=embed"
            loading="lazy">
          </iframe>
        </div>
...
<footer class="footer">
  ...
  <script src="../assets/js/palestrantes.js"></script>
</body>
</html>
