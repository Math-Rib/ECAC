...
<div class="layout">
  ...
  <div class="sidebar">
    ...
    <a href="./index.php"><div class="sidebar-item"><i class="fa fa-home"></i> Início</div></a>
    <a href="./eventos.php"><div class="sidebar-item active"><i class="fa fa-calendar-check"></i> Evento</div></a>
    <a href="./normas.php"><div class="sidebar-item"><i class="fa fa-shield"></i> Normas</div></a>
    <a href="./submissao.php"><div class="sidebar-item"><i class="fa fa-upload"></i> Submissão</div></a>
    <a href="./inscricao.php"><div class="sidebar-item"><i class="fa fa-id-card"></i> Inscrição</div></a>
    <a href="./arquivos.php"><div class="sidebar-item"><i class="fa fa-download"></i> Arquivos</div></a>
    <a href="./palestrantes.php"><div class="sidebar-item"><i class="fa fa-phone"></i> Contato</div></a>
  </div>
...
<div id="modalEvento" class="modal-evento">
  <div class="modal-box">
    ...
    <p><strong>Descrição:</strong> Evento voltado à troca de experiências, debates e atualização profissional na área de Alimentação Coletiva.</p>
    ...
    <ul class="programacao">
      ...
      <li><strong>09h10 – 09h40:</strong> Alimentação Coletiva no RJ: Desafios Atuais e Perspectivas para o Futuro</li>
    ...
    <div class="footer-col footer-right">
      ...
      <div class="social">
        <a href="https://www.instagram.com/ecac.alimentacaocoletiva/" target="_blank">
          <img src="../assets/img/instagram.png" class="img-rodape">
        </a>
        <a href="#" onclick="abrirEmail(event)">
          <img src="../assets/img/x.png" class="img-rodape">
        </a>
        <a href="#" onclick="abrirWhatsApp(event)">
          <img src="../assets/img/telefone.png" class="img-rodape">
        </a>
      </div>
      <p>(21) 99214-1882</p>
    </div>
